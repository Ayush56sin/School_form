...
<body>
    ...
    if (move_uploaded_file($image['tmp_name'], $destination)) {
        ...
        if ($conn->connect_error) {
            ...
            $stmt = $conn->prepare("INSERT INTO users (First_name, gender, Last_name, Standard, Division,Gr, image_file) VALUES (?, ?, ?, ?, ?,?, ?)");
            $stmt->bind_param("sssssis", $FirstName, $gender, $LastName, $Standard, $Division, $Gr, $new_file_name);
            $stmt->execute();
